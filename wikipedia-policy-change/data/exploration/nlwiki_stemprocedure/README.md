...
- `04_statements_v2_inclusive.csv` — #5 **gracious** pass (43): + intro principles, all of Art.1, qualifiers/parentheticals, compound splits; adds a `prominence` col (core/supporting/context) so lead/context is **down-weighted, not dropped**
